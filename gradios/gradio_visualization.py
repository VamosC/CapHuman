...
def process(input_image, pose_image, num_samples, image_resolution, ddim_steps, strength, scale, seed, eta, modes, prompt, a_prompt, n_prompt, tau, controlnet_strength):
...
if __name__ == '__main__':
    ...
    with block:
        ...
        with gr.Row():
            with gr.Column():
                input_image = gr.Image(label="Reference Image", source='upload', type="filepath")
                pose_image = gr.Image(label="Reference Pose Image", source='upload', type="filepath")
                ...
                modes = gr.Textbox(label="Modes", value='position,pose')
        ...
        ips = [input_image, pose_image, num_samples, image_resolution, ddim_steps, strength, scale, seed, eta, modes, prompt, a_prompt, n_prompt, tau, controlnet_strength]
