...
from transformers import T5Tokenizer, T5EncoderModel, CLIPTokenizer, CLIPTextModel, CLIPVisionModel, CLIPProcessor
...
class FrozenCLIPEmbedder(AbstractEncoder):
    ...
    def forward(self, image):
        ...
        #                                 return_overflowing_tokens=False, padding="max_length", return_tensors="pt")
        # tokens = batch_encoding["input_ids"].to(self.device)
        images = batch_encoding["pixel_values"].to(self.device)
...
class FrozenOpenCLIPEmbedder(AbstractEncoder):
    ...
    def forward(self, image):
        ...
        z = self.encode_with_transformer(image.to(self.device))
